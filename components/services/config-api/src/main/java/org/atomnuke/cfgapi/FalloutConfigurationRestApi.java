 ...
 */
@NukeService
public class FalloutConfigurationRestApi implements Service {

   private static final Logger LOG = LoggerFactory.getLogger(FalloutConfigurationRestApi.class);
   ...
   public void init(ServiceContext serviceCtx) throws InitializationException {
      try {
         ...
         servletContextHandler = contextBuilder.newContext("/cfg");
