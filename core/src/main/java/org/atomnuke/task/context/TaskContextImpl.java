...
public class TaskContextImpl implements AtomTaskContext {
   ...
   public TaskContextImpl(NukeEnvironment nukeEnvironment, Logger log, Map<String, String> parameters, ServicesInterrogator servicesInterrogator, AtomTasker submitter) {
